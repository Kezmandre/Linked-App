  ...
  return (
    <footer className="m-0 pt-12 border-box bg-colorBg">
      <div className=" flex-col md:flex-row flex gap-6 justify-start md:justify-between md:items-center ml-12 mr-12 py-6">
        ...
        <div className="w-grow font-montserrat">
          <h3 className="font-clash font-semibold text-xl text-textColor pb-2">
            Useful Links
          </h3>
          <ul className="text-white  cursor-pointer pb-2">
            <li className="pb-1">Overview</li>
            <li className="pb-1">Timeline</li>
            <li className="pb-1">FAQs</li>
            <li className="pb-1">Register</li>
          </ul>
        ...
        <div className="w-grow">
          <h3 className="font-clash font-semibold text-textColor text-xl pb-2">
            Contact Us
          </h3>
          <div className="flex justify-start items-center gap-4 text-white font-clash mb-6">
            <LuPhoneCall />
            <p>+234 9123456789</p>
          </div>
